        ...
        for ($i = 6; $i <= 18; $i++) {
            DB::table('excercises')->insert([
                [
                    ...
                    'video_link' => 'https://www.youtube.com/embed/AOfYbPxk0jY',
                    'category_id' => $i,
                    ...
                    'content' => 'Top 5 bài tập cho cơ bụng cực an toàn cho cột sống của bạn',
                    'video_link' => 'https://www.youtube.com/watch?v=mxWissvKVj0',
                    'category_id' => $i,
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],[
                    ...
                    'video_link' => 'https://www.youtube.com/watch?v=je7lKf3m3gw',
                    'category_id' => $i,
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],[
