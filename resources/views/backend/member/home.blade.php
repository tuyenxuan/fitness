            ...
            @if (isset($lesson_tomorrows))
                @foreach ($lesson_tomorrows as $lesson_tomorrow )
                    <div class="lesson">
                        ...
                        <div class="view-lesson">
                            <a href="{{ route('show_excercise_detail', $lesson_tomorrow->id) }}" target="_blank">Xem bài học</a>
                        </div>
                    </div>
                @endforeach
            @endif
